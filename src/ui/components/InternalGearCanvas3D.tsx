...
import type { InternalGearParams, ViewMode } from '../../core/gearTypes';
...
// Profile in XY plane, thickness along Z — no rotateX
...
interface Props extends InternalGearParams { viewMode: ViewMode; }

export default function InternalGearCanvas3D({ ringTeeth, pinionTeeth, moduleMm, pressureAngleDeg, wallThicknessMm, thicknessMm, viewMode }: Props) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const tick = () => {
        ...
        // Detect 3D→2D: wrap rotation to shortest path
        ...
        // Orbital — no auto-spin; decay to 0 in 2D
        ...
        pinPivot.rotation.z  = spinPin;
        ringPivot.rotation.z = spinRing;
